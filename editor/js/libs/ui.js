...
UI.DownloadPanel.prototype = Object.create(UI.Element.prototype);
UI.DownloadPanel.prototype.constructor = UI.DownloadPanel;
...
UI.Download.prototype = Object.create(UI.Download.prototype);
UI.Download.prototype.constructor = UI.Download;

UI.Download.prototype.getValue = function () {
	return this.dom.textContent;
};

UI.Download.prototype.setValue = function (value) {
	if (value !== undefined) {
		this.dom.textContent = value;
	}
